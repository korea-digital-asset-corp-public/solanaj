...
public class TransactionTest {
  ...
  public void testMultipleSignatures() {
    KeyPair anotherKeyPair =
        KeyPair.fromSecretKey(
            Base58.decode(
                "3Z7cXSyeFR8wNGMVXUE1TwtKn5D5Vu7FzEv69dokLv7KrQk7h6pu4LF8ZRR9yQBhc7uSM6RTTZtU1fmaxiNrxXrs"));
    ...
    assertEquals(
        ...
        transaction.getSignatures().size(),
        "The number of signatures should match the expected count.");
  }
}
